...
function getParticleDirectionAngle(direction, position, center) {
	...
	switch (direction) {
		case MoveDirection.top: return -Math.PI * half$8;
		...
		case MoveDirection.bottom: return Math.PI * half$8;
		...
		default: return getRandom() * doublePI$3;
	}
}
...
var Particle = class {
	constructor(engine, container) {
		...
		this._calculateVelocity = () => {
			...
			const rad = degToRad(getRangeValue(moveOptions.angle.value)), radOffset = degToRad(getRangeValue(moveOptions.angle.offset)), range = {
				left: radOffset - rad * half$8,
				right: radOffset + rad * half$8
			};
		...
		this._getRollColor = (color) => {
			...
			const backFactor = this.roll.horizontal && this.roll.vertical ? 2 : 1, backSum = this.roll.horizontal ? Math.PI * half$8 : 0;
	...
	getMass() {
		return this.getRadius() ** 2 * Math.PI * half$8;
	}
	getPosition() {
		return {
	...
	constructor(rectangle, capacity) {
		...
		this._subdivide = () => {
			...
			for (let i = 0; i < 4; i++) {
				...
				this._subs.push(new QuadTree(new Rectangle(x + width * half$8 * fixedIndex, y + height * half$8 * (Math.round(i * half$8) - fixedIndex), width * half$8, height * half$8), capacity));
			}
			this._divided = true;
		};
		this._points = [];
